...
function hasDecryptGod()
    if exports["pw-inventory"]:hasEnoughOfItem("decrypterenzo",1,false,false) then
      return true
    else
      return false
    end
...
function getQuantitys()
    local weed = exports["pw-inventory"]:getQuantity("weedoz")
    local cocaine = exports["pw-inventory"]:getQuantity("coke5g")
    local guns = exports["pw-inventory"]:getQuantity("riflebody")
    local launder = exports["pw-inventory"]:getQuantity("inkset")
    local stolengoods = exports["pw-inventory"]:getQuantity("valuablegoods")
...
function hasEncryption()
    if (exports["pw-inventory"]:hasEnoughOfItem("decryptersess",1,false) or exports["pw-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)) then
      return true
    else
      return false
    end
...
function hasDevice()
    if exports["pw-inventory"]:hasEnoughOfItem("mk2usbdevice",1,false) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
...
function hasPhone()
    if exports["pw-inventory"]:hasEnoughOfItem("mobilephone",1,false) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
...
function getQuantitysH()
    local weed = exports["pw-inventory"]:getQuantity("weed5oz")
    local cocaine = exports["pw-inventory"]:getQuantity("coke50g")
    local guns = exports["pw-inventory"]:getQuantity("riflebodybox")
    local launder = exports["pw-inventory"]:getQuantity("inkcrate")
...
function attemptDecrypt()
    ...
    local usb = exports["pw-inventory"]:hasEnoughOfItem("mk2usbdevice",1,false)
    local usb2 = exports["pw-inventory"]:hasEnoughOfItem("usbdevice",1,false)
    local base = exports["pw-inventory"]:hasEnoughOfItem("decryptersess",1,false)
    local expert = exports["pw-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)
    local expert2 = exports["pw-inventory"]:hasEnoughOfItem("decrypterenzo",1,false)
...
RegisterCommand('oktes', function()

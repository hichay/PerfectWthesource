...
QBOccasions.setupSellContract = function(data) {
    $("#seller-name").html(data.pData.firstname + " " + data.pData.lastname);
    $("#seller-banknr").html(data.pData.iban);
    $("#seller-telnr").html(data.pData.phone);
    $("#vehicle-plate").html(data.plate);
}

QBOccasions.setupBuyContract = function(data, vData) {
    $("#buy-seller-name").html(data.sellerData.firstname + " " + data.sellerData.lastname);
    $("#buy-seller-banknr").html(data.sellerData.iban);
    $("#buy-seller-telnr").html(data.sellerData.phone);

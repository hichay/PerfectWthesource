...
AddEventHandler('pw-garages:server:setFirstData', function()
    ...
    exports['ghmattimysql']:execute("SELECT * FROM `owned_vehicles`", function(vehicles)
        if vehicles[1] ~= nil then
            ...
            print('^6[PerfectW garages] ^7Loaded ' .. tostring(math.ceil(counter)) .. ' vehicles.')
        ...
        exports['ghmattimysql']:execute("SELECT * FROM `player_houses`", function(housing)
            ...
            if housing[1] ~= nil then
                ...
                print('^6[PerfectW garages] ^7Loaded ' .. tostring(counter) .. ' house garages.')
            else
                print('^6[PerfectW garages] ^7Could not find any house garages.')
            end

            TriggerClientEvent('pw-garages:client:syncConfig', -1, 1, serverConfig)
            print('^6[PerfectW garages] ^7Waiting for first player in order to create vehicles.')
...
AddEventHandler("pw-garages:server:removeOldVehicle", function(plate)

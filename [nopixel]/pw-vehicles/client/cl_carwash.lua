...
local function cleanVehicle()
    ...
    local clean = RPC.execute("pw-carwash:cleanVehicle")
...
AddEventHandler("pw-polyzone:enter", function(zone)
    if zone ~= "car_wash" then return end
    if not IsPedSittingInAnyVehicle(PlayerPedId()) then return end
	print('a')
    exports["np-interact"]:showInteraction("[E] Limpar o Veiculo $100")
    listenForKeypress()
end)
...
Citizen.CreateThread(function()
    -- Strawberry
    exports["pw-polyzone"]:AddBoxZone("car_wash", vector3(26.59, -1392.02, 27.36), 3.0, 3.0, {
        heading=0,
        minZ=25.00,
        maxZ=32.00,
    })
    ...
    -- Davis
    exports["pw-polyzone"]:AddBoxZone("car_wash", vector3(175.03, -1736.63, 29.29), 6.0, 6.0, {
        heading=0,
        minZ=25.00,
        maxZ=32.00,
    })
    ...
    -- Little Seoul
    exports["pw-polyzone"]:AddBoxZone("car_wash", vector3(-699.96, -933.30, 19.01), 6.0, 6.0, {
        heading=0,
        minZ=18.00,
        maxZ=22.00,
    })
    ...
    -- Sandy Shores
    exports["pw-polyzone"]:AddBoxZone("car_wash", vector3(1362.53, 3592.12, 33.92), 6.0, 6.0, {
        heading=115,
        minZ=33.00,
        maxZ=38.00,
    })

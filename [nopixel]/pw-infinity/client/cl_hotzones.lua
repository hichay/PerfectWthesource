...
RegisterNetEvent("pw-infinity:hotzones:updateList")
AddEventHandler("pw-infinity:hotzones:updateList", function(zones)
...
Citizen.CreateThread(function()
    ...
    TriggerServerEvent("pw-infinity:hotzones:requestList")
    ...
    while true do
        ...
        for zoneId, zone in pairs(HotZones) do
            ...
            if isNear and not zone.inside and zone.tick >= 2 then
                zone.inside = true
                TriggerServerEvent("pw-infinity:hotzones:enteredZone", zoneId)
            ...
            elseif not isNear and zone and zone.inside and zone.tick <= 0 then
                zone.inside = false
                TriggerServerEvent("pw-infinity:hotzones:exitZone", zoneId)

...
Citizen.CreateThread(function()
    while GetResourceState("pw-density") ~= "started" do
        Citizen.Wait(100)
    end

    exports["pw-density"]:RegisterDensityReason("interior", 3)
    ...
    while true do
        ...
        if inInterior and not IsInsideInterior and InteriorTick >= 2 then
            ...
            exports["pw-density"]:ChangeDensity("interior", 0.4)
            TriggerEvent("pw-voice:setQuietMode", "interior", true, 2)
            TriggerServerEvent("pw-infinity:interiors:enteredInterior", interiorId)
        ...
        elseif not inInterior and IsInsideInterior and InteriorTick <= 1 then
            ...
            exports["pw-density"]:ChangeDensity("interior", -1)
            TriggerEvent("pw-voice:setQuietMode", "interior", false)
            TriggerServerEvent("pw-infinity:interiors:exitInterior", interiorId)

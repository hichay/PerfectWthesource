...
function StartPeekin()
    ...
    NearZones = {}
    nearbyZones = exports["pw-polytarget"]:GetZones(GetEntityCoords(PlayerPedId())) or {}
...
AddEventHandler('pw-polyzone:enter', function(zoneName, zoneData, zoneCenter)
...
AddEventHandler('pw-polyzone:exit', function(zoneName)
    if not PeekEntries['polytarget'][zoneName] then return end
...
Citizen.CreateThread(function()
    exports["pw-keybinds"]:registerKeyMapping("", "Player", "Peek at Target", "+targetInteract", "-targetInteract", "LMENU")
end)
...
AddEventHandler("pw-preferences:setPreferences", function(data)

...
function SetEngineSound(pVehicle)
    local sound = exports["pw-vehicles"]:GetVehicleAfterMarket(pVehicle, "engineSound")
...
function RequestSyncStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent("pw-vehicleSync:updateSyncState", netId, syncState)
    end)
end
...
RegisterNetEvent("pw-vehicles:spawnedVehicleSync")
AddEventHandler("pw-vehicles:spawnedVehicleSync", function(pNetId, pModel)
    Citizen.Wait(1000)
    ...
    local afterMarkets = exports["pw-vehicles"]:GetVehicleAfterMarket(vehicle)
...
Citizen.CreateThread(function()
    exports["pw-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Neon Lights", "+toggleNeonLights", "-toggleNeonLights")
    exports["pw-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Right)", "+toggleRightIndicator", "-toggleRightIndicator")
    exports["pw-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Left)", "+toggleLeftIndicator", "-toggleLeftIndicator")
    exports["pw-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Hazard)", "+toggleHazardLights", "-toggleHazardLights")
end)
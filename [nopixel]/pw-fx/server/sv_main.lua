RegisterNetEvent("pw-fx:smoke:grenade", function(pCoords)
    local players = exports["pw-infinity"]:GetNerbyPlayers(pCoords, 100)
...
RegisterNetEvent("fx:poo:start", function(PooingID)
    ...
    local players = exports["pw-infinity"]:GetNerbyPlayers(coords, 25)

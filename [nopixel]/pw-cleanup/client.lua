...
AddEventHandler("pw-cleanup:enableCleanup", function(pEnabled)
...
RegisterNetEvent('pw-cleanup:clearAreaOfEverything')
AddEventHandler('pw-cleanup:clearAreaOfEverything', function (vectors, radius)
    ClearAreaOfEverything(vectors.x, vectors.y, vectors.z, radius, false, false, false, false)
end)

RegisterNetEvent('pw-cleanup:clearAreaOfObjects')
AddEventHandler('pw-cleanup:clearAreaOfObjects', function (vectors, radius)
    ClearAreaOfObjects(vectors.x, vectors.y, vectors.z, radius)
end)

RegisterNetEvent('pw-cleanup:clearAreaOfPeds')
AddEventHandler('pw-cleanup:clearAreaOfPeds', function (vectors, radius)
    ClearAreaOfPeds(vectors.x, vectors.y, vectors.z, radius)
end)

RegisterNetEvent('pw-cleanup:clearAreaOfVehicles')
AddEventHandler('pw-cleanup:clearAreaOfVehicles', function (vectors, radius)
    ClearAreaOfVehicles(vectors.x, vectors.y, vectors.z, radius, false, false, false, false)
end)


-- Listen for polyzone events for prison
AddEventHandler("pw-polyzone:enter", function(pZone, pData)
...
AddEventHandler("pw-polyzone:exit", function(pZone, pData)
   -- Check does this zone even have black listed models?
    if BlackListedPropsByZone[pZone] then

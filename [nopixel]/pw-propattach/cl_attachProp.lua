...
AddEventHandler("pw-props:attachProp", function(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex, name)
  attachProp(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex, name)
end)
AddEventHandler("pw-props:removeProp", function()
  removeAttachedProp()
end)
AddEventHandler("pw-props:removePropByName", function(pName)

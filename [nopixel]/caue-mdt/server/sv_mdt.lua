...
AddEventHandler("caue-mdt:callAttach", function(callid)
    local src = source
    local xPlayer = ESX.GetPlayerFromId(source)
    local units = exports["caue-dispatch"]:addUnit(xPlayer.id, callid)
...
AddEventHandler("caue-mdt:callDetach", function(callid)
    local src = source
    local xPlayer = ESX.GetPlayerFromId(source)
    local units = exports["caue-dispatch"]:removeUnit(xPlayer.id, callid)
...
AddEventHandler("caue-mdt:callDragAttach", function(callid, cid)
    ...
    local units = exports["caue-dispatch"]:addUnit(cid, callid)
...
AddEventHandler("caue-mdt:callDispatchDetach", function(callid, cid)
    ...
    local units = exports["caue-dispatch"]:removeUnit(cid, callid)

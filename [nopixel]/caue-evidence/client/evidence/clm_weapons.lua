...
--[[ local dropBulletCasing = function(pPed, pWeaponHash, pWeaponType, pIdentifier)
    ...
    local meta = {
        ...
        ["text"] = "Vỏ đạn",
        ["Loại bằng chứng"] = "Vỏ đạn",
        ["Loại đạn"] = weaponsAmmo[tostring(pWeaponHash)] or "NOT DEFINED",
        ["_hideKeys"] = { "type", "identifier", "text" },
    }

    TriggerEvent("pw-evidence:dropEvidence", vector3(x, y, z), meta)
end ]]
...
local dropBulletCasing = function(pPed, pWeaponHash, pWeaponType, pIdentifier)
    ...
    local meta = {
        ...
        ["_hideKeys"] = { "evidenceType", "identifier", "text" },
    }
...
--[[ local dropImpactFragment = function(pPed, pDist, pWeaponHash, pWeaponType, pIdentifier)
    ...
    if isAVehicle == 1 and math.random(4) > 1 then
        ...
        meta = {
            ...
            ["text"] = "Mảnh vỡ phương tiện",
            ["rgb"] = { ["r"] = r, ["g"] = g, ["b"] = b },
            ["Loại bằng chứng"] = "Mảnh xe màu",
    ...
    TriggerEvent("pw-evidence:dropEvidence", result.hitPosition, meta, "p")
end ]]
...
local dropImpactFragment = function(pPed, pDist, pWeaponHash, pWeaponType, pIdentifier)
    ...
    if isAVehicle == 1 and math.random(4) > 1 then
        ...
        meta = {
            ...
            ["identifier"] = result.entityHit,
            ['text'] = "Mảnh vỡ",
            ["Loại bằng chứng"] = "Mảnh vỡ",
            ["Màu chính"] = colors[color1],
            ["Màu phụ"] = colors[color2],
            ["Kết quả"] = "Cần phân tích",
            ["_hideKeys"] = { "type", "identifier", "text" },
        }

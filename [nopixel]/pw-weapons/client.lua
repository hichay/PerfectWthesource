...
RegisterNetEvent('pw-weapons:destroyGroundWeapon')
AddEventHandler('pw-weapons:destroyGroundWeapon', function()
	DeleteEntity(weapon)
end)

RegisterNetEvent('pw-weapons:allowDrop')
AddEventHandler('pw-weapons:allowDrop', function()
	canDrop = true
end)

RegisterNetEvent('pw-weapons:dropweapon')
AddEventHandler('pw-weapons:dropweapon', function(AmountOfCurrentWeapon,weaponModel,rowID)
    ...
    canDrop = false
	TriggerServerEvent("pw-weapons:dropweapon",{pos.x,pos.y,pos.z+0.75},name,rowID)
...
RegisterNetEvent('pw-weapons:doHandOver')
AddEventHandler('pw-weapons:doHandOver', function(weapon)
  --GiveWeaponToPed(PlayerPedId(), tonumber(weapon), 0, 0, false)
  TriggerEvent("attachWeapons")
end)

RegisterNetEvent('pw-weapons:dropweaponSearch')
AddEventHandler('pw-weapons:dropweaponSearch', function(weapon)
	--RemoveWeaponFromPed(PlayerPedId(),tonumber(weapon))
  TriggerEvent("attachWeapons")
end)


RegisterNetEvent('pw-weapons:giveweapon')
AddEventHandler('pw-weapons:giveweapon', function(toPlayer,AmountOfCurrentWeapon,weaponModel,rowID)
	...
	if not IsPedInAnyVehicle(PlayerPedId(),true) then
		...
		if (playing ~= false) then
			...
			TriggerServerEvent("pw-weapons:giveweapon", toPlayer, name,rowID)
			Wait(1300)
			TriggerServerEvent("weaponshop:removeSingleWeapon",rowID)
			TriggerEvent("attachWeapons")
		else

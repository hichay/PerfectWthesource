...
AddEventHandler("clothing:checkIfNew", function()
    ...
    MySQL.query("SELECT id FROM users WHERE identifier = @identifier LIMIT 1", {
        ...
        if result == nil then
            ...
            TriggerEvent("raid_clothes:get_character_face", src)
        end
...
RegisterNetEvent("clothing:removeTattoosForPlayer")
AddEventHandler("clothing:removeTattoosForPlayer", function(tattoosList)

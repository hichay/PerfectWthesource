...
Citizen.CreateThread(function()
	...
	-- Male Hair
	AddNewVariation("Hair", "Male", 7, 65, true)
	AddNewVariation("Hair", "Male", 43, 15, true)
	AddNewVariation("Hair", "Male", 9, 65, true)
	AddNewVariation("Hair", "Male", 11, 65, true)
	AddNewVariation("Hair", "Male", 15, 65, true)
	AddNewVariation("Hair", "Male", 16, 65, true)
	AddNewVariation("Hair", "Male", 17, 65, true)
	AddNewVariation("Hair", "Male", 20, 65, true)
	AddNewVariation("Hair", "Male", 22, 65, true)
	AddNewVariation("Hair", "Male", 45, 65, true)
	AddNewVariation("Hair", "Male", 47, 65, true)
	AddNewVariation("Hair", "Male", 49, 65, true)
	AddNewVariation("Hair", "Male", 51, 65, true)
	AddNewVariation("Hair", "Male", 52, 65, true)
	AddNewVariation("Hair", "Male", 53, 65, true)
	AddNewVariation("Hair", "Male", 56, 65, true)
	AddNewVariation("Hair", "Male", 58, 65, true)
	-- Female Hair

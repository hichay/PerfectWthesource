...
function InitMenu()
    TriggerServerEvent("pw-clothes:loadPlayerSkin")
    CreateBlips()
    LoadAnims()
...
RegisterCommand('testy', function(source, args, RawCommand)
    print("succes")
    TriggerEvent("pw-clothing:client:openMenu")
...
RegisterNetEvent('pw-clothing:client:openMenu', function()
    openMenu({
...
RegisterNetEvent('pw-clothing:client:getOutfits', function(Job, Grade)
...
RegisterNetEvent('pw-clothes:client:CreateFirstCharacter', function(gender)
    --local LocalPlayer = exports["np-base"]:getModule("LocalPlayer")
    local gender = nil
    ESX.TriggerServerCallback('raid_clothes:getSex', function(sex)
        gender = sex
...
RegisterNetEvent("pw-clothes:loadSkin", function(new, model, data)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent('pw-clothing:client:loadPlayerClothing', data, PlayerPedId())
    end)
end)

RegisterNetEvent('pw-clothing:client:loadPlayerClothing', function(data, ped)
...
RegisterNetEvent('pw-clothing:client:loadOutfit', function(oData)
...
RegisterNetEvent("pw-clothes:client:loadPlayerSkin", function()
    TriggerServerEvent('pw-clothes:loadPlayerSkin')
end)
...
RegisterNUICallback('selectOutfit', function(data, cb)
    TriggerEvent('pw-clothing:client:loadOutfit', data)
    cb('ok')
end)
...
RegisterNUICallback('saveOutfit', function(data, cb)
    ...
    TriggerServerEvent('pw-clothes:saveOutfit', data.outfitName, model, Config.SkinData)
    cb('ok')
end)
...
RegisterNUICallback('removeOutfit', function(data, cb)
    TriggerServerEvent('pw-clothing:server:removeOutfit', data.outfitName, data.outfitId)
...
RegisterNUICallback('toggleVariation', function(data, cb)
    ...
    TriggerEvent('pw-clothing:client:loadOutfit', ClothingData)
    cb('ok')
end)

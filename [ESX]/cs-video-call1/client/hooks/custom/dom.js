window.CS_VIDEO_CALL.hookInterface = () => {
    jQuery('.phone-call-app:first').prepend(`
    ...
    jQuery('.phone-call-app:first .phone-call-ongoing:first #ongoing-cancel').before('<div data-action="cs-video-call-swap-transmission" style="display: none;"><i class="fas fa-video"></i></div>')

    return jQuery('.phone-call-app:first')
}

jQuery(document).ready(() => window.CS_VIDEO_CALL.hookDocument())

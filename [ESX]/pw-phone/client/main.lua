...
local function OpenPhone()
	...
	if exports["pw-inventory"]:hasEnoughOfItem("mobilephone",1,false) then
		ESX.TriggerServerCallback('qb-phone:server:GetCharacterData', function(chardata)
			...
			-- ESX.TriggerServerCallback('qb-garage:server:GetPlayerVehicles', function(vehicles)
...
RegisterNUICallback('SetBackground', function(data)
    ...
    TriggerServerEvent('qb-phone:server:SaveMetaData', 'background', PhoneData.MetaData)
end)
...
RegisterNUICallback('PayInvoice', function(data, cb)
    ...
    ESX.TriggerServerCallback('qb-phone:server:PayInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('CallContact', function(data, cb)
    ESX.TriggerServerCallback('qb-phone:server:GetCallState', function(CanCall, IsOnline, contactData)
        local status = {
            CanCall = CanCall,
            IsOnline = IsOnline,

...
MI.Phone.Functions.LoadPhoneData = function(data) {
    ...
    MI.Phone.Functions.RefreshAutoscout(data.PhoneData.Cars);
...
$(document).ready(function(){
    window.addEventListener('message', function(event) {
        switch(event.data.action) {
            ...
            case "UpdateCallTime":
                ...
                if (!MI.Phone.Data.IsOpen) {
                    ...
                    $(".call-notifications-title").html("Đang gọi ("+timeString+")");
                    $(".call-notifications-content").html("Đang gọi cho "+event.data.Name);
                ...
                $(".phone-currentcall-title").html("Đang gọi ("+timeString+")");
                break;
	    ...
	    case "RefreshAutoscout":
                MI.Phone.Functions.RefreshAutoscout(event.data.Cars);
                break;	
            case "AddPoliceAlert":

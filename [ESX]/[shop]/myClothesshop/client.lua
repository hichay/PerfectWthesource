...
function ShowNotification(text,typeno)
	TriggerEvent("ESX:Notify",text,typeno)
end
                        ...
                        if item == takeOn then
                            TriggerEvent('skinchanger:getSkin', function(skin)
                                ...
                                TriggerEvent('skinchanger:getSkin', function(skinnew)
									TriggerServerEvent('skin:save', skinnew)
									LastSkin = skinnew
                                end)
...
AddEventHandler('myClothesshop:confirm', function(enoughMoney)
	...
	if enoughMoney then
		TriggerEvent('skinchanger:getSkin', function(skin)
			...
			if LastSkin['watches_1'] ~= skin['watches_1'] or LastSkin['watches_2'] ~= skin['watches_2'] then
				if Config.ForceAccessoiresDelete then
					TriggerEvent('skinchanger:change', 'watches_1', -1)
				end
				TriggerServerEvent('accessoires:updateAccessoire', 'bracelets', skin['watches_1'], skin['watches_2'])
			end

			if LastSkin['bracelets_1'] ~= skin['bracelets_1'] or LastSkin['bracelets_2'] ~= skin['bracelets_2'] then
				if Config.ForceAccessoiresDelete then
					TriggerEvent('skinchanger:change', 'bracelets_1', -1)
				end
				TriggerServerEvent('accessoires:updateAccessoire', 'bracelets', skin['bracelets_1'], skin['bracelets_2'])
			end

			if LastSkin['decals_1'] ~= skin['decals_1'] or LastSkin['decals_2'] ~= skin['decals_2'] then
				if Config.ForceAccessoiresDelete then
					TriggerEvent('skinchanger:change', 'decals_1', -1)
				end
				TriggerServerEvent('accessoires:updateAccessoire', 'bracelets', skin['decals_1'], skin['decals_2'])
			end
			
			if LastSkin['bproof_1'] ~= skin['bproof_1'] or LastSkin['bproof_2'] ~= skin['bproof_2'] then
				if Config.ForceAccessoiresDelete then
					TriggerEvent('skinchanger:change', 'bproof_1', -1)
				end
				TriggerServerEvent('accessoires:updateAccessoire', 'bracelets', skin['bproof_1'], skin['bproof_2'])
			end
			...
			TriggerEvent('skinchanger:getSkin', function(finalSkin)
				...
				if Config.useESXClothesData then
					ESX.TriggerServerCallback('myClothesshop:checkHavePropertyStore', function(foundStore)
						if foundStore then
							local outfitname = CreateDialog('Name')

SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        $(".lawyers-list").append('<h1 style="font-size:16px; padding:10px; color:#fff; margin-top:0; border-top-left-radius: .5vh; border-top-right-radius: .5vh; width:100%; display:block; background-color: rgb(42, 137, 214);">Lawyers ('+lawyers.length+')</h1>');
        if (lawyers.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">There is no lawyer available.</div></div>'
            $(".lawyers-list").append(element);
        }

        $(".lawyers-list").append('<br><h1 style="font-size:16px; padding:10px; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(155, 15, 120);">Estate agents ('+realestate.length+')</h1>');
        ...
        if (realestate.length > 0) {            
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">There is no estate agent available.</div></div>'
            $(".lawyers-list").append(element);
        }

         // Cardealer
        $(".lawyers-list").append('<br><h1 style="font-size:16px; padding:10px; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(235, 183, 52);">Cardealers ('+cardealer.length+')</h1>');

...
$(document).on('click', '#garage-pricescreen-sellveh', function(e){
    ...
    if (vehicle !== "") {
        ...
        QB.Phone.Notifications.Add("fas fa-car", "Autoscout24", "Vehicle has been advertised on AutoScout24!", "#f39c12", 2000);
    } else {
        QB.Phone.Notifications.Add("fas fa-times-circle", "Oops...", "Something went wrong, Try again later...", "#e74c3c", 2000);
    }

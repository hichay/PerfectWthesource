...
AddEventHandler('RunUseItem', function(itemid, slot, inventoryName, isWeapon, passedItemInfo)
    ...
    if (itemid == "tuner") then
      ...
      local finished = exports["np-taskbar"]:taskBar(2000,"Connecting Tuner Laptop",true,true,playerVeh)
    ...
    if (itemid == "lsdtab" or itemid == "badlsdtab") then
        ...
        local finished = exports["np-taskbar"]:taskBar(3000,"Placing LSD Strip on 👅",true,true,playerVeh)
        if (finished == 100) then
    ...
    if (itemid == "decryptersess" or itemid == "decrypterfv2" or itemid == "decrypterenzo") then
      if (#(GetEntityCoords(player) - vector3( 1275.49, -1710.39, 54.78)) < 3.0) then
          local finished = exports["np-taskbar"]:taskBar(25000,"Decrypting Data",true,true,playerVeh)
          if (finished == 100) then
    ...
    if (itemid == "weedoz") then
      ...
      local finished = exports["np-taskbar"]:taskBar(5000,"Packing Q Bags",true,true,playerVeh)
        if (finished == 100) then
    ...
    if ( itemid == "smallbud" and hasEnoughOfItem("qualityscales",1,false) ) then
        local finished = exports["np-taskbar"]:taskBar(1000,"Đóng gói",true,true,playerVeh)
        if (finished == 100) then
    ...
    if (itemid == "weedq") then
        local finished = exports["np-taskbar"]:taskBar(1000,"Cuốn cần",true,true,playerVeh)
        if (finished == 100) then
    ...
    if (itemid == "lighter") then
        TriggerEvent("animation:PlayAnimation","lighter")
          local finished = exports["np-taskbar"]:taskBar(2000,"Starting Fire",true,true,playerVeh)
        if (finished == 100) then
    ...
    if (itemid == "joint" or itemid == "joint2") then
        local finished = exports["np-taskbar"]:taskBar(2000,"Hút cuốn",true,true,playerVeh)
        if (finished == 100) then
            Wait(200)
     ...
     if (itemid == "Gruppe6Card") then
        ...
        if targetVehicle ~= 0 and GetHashKey("stockade") == GetEntityModel(targetVehicle) then
            ...
            if aDist < 2.0 then
                ...
                local finished = exports["np-taskbar"]:taskBar(timeToOpen,"Unlocking Vehicle",true,true,playerVeh)
                if finished == 100 then
                    remove = true
    ...
    if (itemid == "usbdevice") then
        local finished = exports["np-taskbar"]:taskBar(15000,"Scanning For Networks",true,true,playerVeh)
        if (finished == 100) then
    ...
    if (itemid == "armor") then
        local finished = exports["np-taskbar"]:taskBar(10000,"Armor",true,true,playerVeh)
        if (finished == 100) then
    ...
    if (itemid == "cbrownie" or itemid == "cgummies") then
        TriggerEvent("animation:PlayAnimation","pill")
        local finished = exports["np-taskbar"]:taskBar(3000,"Consuming edibles 😉",true,true,playerVeh)
        if (finished == 100) then
    ...
    if (itemid == "bodybag") then
        local finished = exports["np-taskbar"]:taskBar(10000,"Opening bag",true,true,playerVeh)
        if (finished == 100) then
            remove = true
    ...
    if (itemid == "bodygarbagebag") then
            local finished = exports["np-taskbar"]:taskBar(10000,"Opening trash bag",true,true,playerVeh)
            if (finished == 100) then
                remove = true
    ...
    if (itemid == "foodsupplycrate") then
        ...
        local finished = exports["np-taskbar"]:taskBar(20000,"Opening the crate (ESC to Cancel)",true,true,playerVeh)
        if (finished == 100) then
            remove = true
    ...
    if (itemid == "organcooler") then
        local finished = exports["np-taskbar"]:taskBar(5000,"Opening cooler",true,true,playerVeh)
        if (finished == 100) then
            remove = true
    ...
    if (itemid == "Bankbox") then
        if (hasEnoughOfItem("locksystem",1,false)) then
            local finished = exports["np-taskbar"]:taskBar(10000,"Opening bank box.",true,true,playerVeh)
            if (finished == 100) then
                remove = true
    ...
    if (itemid == "Securebriefcase") then
        if (hasEnoughOfItem("Bankboxkey",1,false)) then
            local finished = exports["np-taskbar"]:taskBar(5000,"Opening briefcase.",true,true,playerVeh)
            if (finished == 100) then
                remove = true
    ...
    if (itemid == "Largesupplycrate") then
        if (hasEnoughOfItem("2227010557",1,false)) then
            local finished = exports["np-taskbar"]:taskBar(15000,"Opening supply crate.",true,true,playerVeh)
            if (finished == 100) then
                remove = true
    ...
    if (itemid == "xmasgiftcoal") then
        local finished = exports["np-taskbar"]:taskBar(15000, "Opening Gift", true, true, playerVeh)
        if (finished == 100) then
            remove = true
            TriggerServerEvent('loot:useItem', itemid)
        end
    ...
    if (itemid == "fishingtacklebox") then
        local finished = exports["np-taskbar"]:taskBar(5000,"Opening",true,true,playerVeh)
        if (finished == 100) then
            remove = true
            TriggerServerEvent('loot:useItem', itemid)
        end
    ...
    if (itemid == "ciggy") then
		if hasEnoughOfItem("lighter",1,false) then
			local finished = exports["np-taskbar"]:taskBar(1000,"Đốt lửa",false,false,playerVeh)
			if (finished == 100) then
				Wait(300)
	...
	if (itemid == "redpack") then
		local finished = exports["np-taskbar"]:taskBar(1000,"Mở bao thuốc",false,false,playerVeh)
		if (finished == 100) then
    ...
    if (itemid == "cigar") then
        local finished = exports["np-taskbar"]:taskBar(1000,"Đốt lửa",true,true,playerVeh)
        if (finished == 100) then
            Wait(300)
	...
	if (itemid == "oxy") then
        local finished = exports["np-taskbar"]:taskBar(2000,"Uống thuốc",true,true,playerVeh)
        if (finished == 100) then
            Wait(300)
    ...
    if (itemid == "oxygentank") then
        local finished = exports["np-taskbar"]:taskBar(30000,"Oxygen Tank",true,true,playerVeh)
        if (finished == 100) then        
    ...
    if (itemid == "bandage") then
		...
		TriggerEvent("pw-hospital:items:bandage")
		remove = true
    end
    ...
    if (itemid == "1gcocaine") then
        ...
        TriggerEvent("fx:run", "cocaine", 180, -1, false)
    end
    ...
    if (itemid == "IFAK") then
		...
		TriggerEvent("pw-hospital:items:ifak")
		remove = true
    end
	...
	if (itemid == "oxynew") then
        local finished = exports["np-taskbar"]:taskBar(5000,"Uống thuốc",true,true,playerVeh)
        if (finished == 100) then
			TriggerEvent("animation:PlayAnimation","pill")
            Wait(300)
...
function TaskItem(dictionary,animation,typeAnim,timer,message,func,remove,itemid,playerVeh,itemreturn,itemreturnid)
    ...
    if timer > 0 then
        local finished = exports["np-taskbar"]:taskBar(timer,message,true,true,playerVeh)
...
AddEventHandler('inv:lockPick', function(isForced,inventoryName,slot)
    ...
    if targetVehicle == 0 then
        ...
        if targetVehicle ~= 0 and not isForced then
            ...
            --local finished = exports["np-taskbarskill"]:taskBar(1500,math.random(1,3))

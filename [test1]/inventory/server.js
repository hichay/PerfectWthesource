...
onNet("server-inventory-give", async (player, itemid, slot, amount, generateInformation, itemdata, openedInv) => {
  ...
  let string = `SELECT item_id, id , amount FROM user_inventory2 WHERE name='${playerinvname}'`;
  exports.ghmattimysql.execute(string, {}, function(result) {
    var itemids = "0"
    var currammount = "0"
    ...
    if (targetName.indexOf("Drop") > -1 || targetName.indexOf("hidden") > -1) {
      exports.ghmattimysql.execute(`SELECT item_id, id , name ,amount FROM user_inventory2 WHERE name='${targetName}' AND item_id='${itemidsent}'`, {}, function(result) {
        ...
        if (invenname == null) {
		  ...
		  if(isWeapon){
			  ...
			  let string = `SELECT information FROM user_inventory2 WHERE name='${originInventory}' AND dropped='0' AND item_id='${itemidsent}' AND slot='${originSlot}'`;
			  exports.ghmattimysql.execute(string, {}, function(result) {
			...
			db(`INSERT INTO user_inventory2 (item_id, name, information, slot, creationDate, amount, dropped) VALUES ('${itemidsent}','${targetName}','${infor}','${targetslot}','${creationDate}' ,'${moveAmount}', '1');`);
			
			  });
		  } else {
          db(`UPDATE user_inventory2 SET amount=amount - '${moveAmount}' WHERE name='${originInventory}' AND dropped='0' AND item_id='${itemidsent}' AND slot='${originSlot}'`);
          db(`INSERT INTO user_inventory2 (item_id, name, information, slot, creationDate, amount, dropped) VALUES ('${itemidsent}','${targetName}','${info}','${targetslot}','${creationDate}' ,'${moveAmount}', '1');`);
		  }
        } else {
      ...
      exports.ghmattimysql.execute(string, {}, function(result) {
        ...
        if (invenname == null) {
		  ...
		  let string = `SELECT information FROM user_inventory2 WHERE name='${originInventory}' AND dropped='1' AND item_id='${itemidsent}' AND slot='${originSlot}'`;
			  exports.ghmattimysql.execute(string, {}, function(result) {

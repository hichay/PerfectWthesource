function PoliceArmory() {
    var shopItems = [
        ...
        { item_id: "-86904375", id: 0, name: "Shop", information: "Police", slot: 2, amount: 5 },
        ...
        { item_id: "pistolammo", id: 0, name: "Shop", information: "{}", slot: 7, amount: 1 },
        { item_id: "rifleammo", id: 0, name: "Shop", information: "{}", slot: 8, amount: 50 },
        { item_id: "armor", id: 0, name: "Shop", information: "{}", slot: 9, amount: 1 },
        ...
        { item_id: "idcard", id: 0, name: "Shop", information: "{}", slot: 15, amount: 50 },
...
function recycle() {
    var shopItems = [
		...
		{ item_id: "3675956304", id: 0, name: "craft", information: "{}", slot: 9, amount: 1 },

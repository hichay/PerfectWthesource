...
$(document).ready(() => {
    ...
    $(".profile-items").on("click", ".profile-item", function () {
        let id = $(this).data("id");
        $.post('https://pw-mdt/getProfileData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".bulletin-add-btn").click(function () {
        if (canCreateBulletin == 0) {
            ...
            $('.bulletin-items-continer').prepend(`<div class="bulletin-item" data-id="${canCreateBulletin}">
                ...
                <div class="bulletin-date">${MyName} - Hiện tại</div>
                </div>
            </div>`)
        } else {
    ...
    $(".bulletin-items-continer").on("keydown", ".bulletin-item", function (e) {
        if (e.keyCode === 13) {
            ...
            let time = new Date()
            $.post('https://pw-mdt/newBulletin', JSON.stringify({
                title: title,
                info: info,
                time: time.getTime()
            }));
    ...
    $(".contextmenu").on("click", ".remove-bulletin", function () {
        ...
        $.post('https://pw-mdt/deleteBulletin', JSON.stringify({
            id: BulletinId,
            time: time.getTime()
        }));
        ...
        if (e.keyCode === 13) {
            ...
            if (URL !== "") {
                ...
                setTimeout(() => {
                    ...
                    $.post('https://pw-mdt/addGalleryImg', JSON.stringify({
                        cid: cid,
                        URL: URL
                    }));
                }, 250);
    ...
    $(".manage-profile-save").click(function () {
        if (canSaveProfile == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://pw-mdt/saveProfile', JSON.stringify({
                    pfp: pfp,
    ...
    $(".manage-incidents-title-holder").on("click", ".manage-incidents-save", function () {
        if (canSaveProfile == true) {
            ...
            $.post('https://pw-mdt/saveIncident', JSON.stringify({
                ID: dbid,
                title: title,
            ...
            setTimeout(() => {
                if (canRefreshIncidents == true) {
                    ...
                    setTimeout(() => {
                        ...
                        $.post('https://pw-mdt/getAllIncidents', JSON.stringify({}));
                    }, 1500);
                }
            }, 1000);
    ...
    $(".manage-incidents-title-holder").on("click", ".manage-incidents-create", function () {
        if ($(".badge-logo").attr('src') == 'https://cdn.discordapp.com/attachments/770324167894761522/912602342275301396/ems_badge.png') {
            ...
            $(".manage-incidents-title-holder").prepend(
                `
                <div class="manage-incidents-title">Chỉnh Sửa Hồ Sơ</div>
    ...
    $(".contextmenu").on("click", ".search-vehicle", function () {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                $.post('https://pw-mdt/searchVehicles', JSON.stringify({
                    name: plate.toString()
                }));
                $(".dmv-items").empty();
                $('.dmv-items').prepend(`<div class="profile-loader"></div>`);
                setTimeout(() => {
                    $.post('https://pw-mdt/getVehicleData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".search-weapon", function () {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                $.post('https://pw-mdt/searchWeapon', JSON.stringify({
                    name: plate.toString()
                }));
                $(".weapons-items").empty();
                $('.weapons-items').prepend(`<div class="profile-loader"></div>`);
                setTimeout(() => {
                    $.post('https://pw-mdt/getWeaponData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".search-house", function () {
        ...
        $.post('https://pw-mdt/searchHouse', JSON.stringify({
    ...
    //     $.post('https://pw-mdt/updateLicence', JSON.stringify({
    ...
    $('#profile-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://pw-mdt/searchProfiles', JSON.stringify({
                    name: name
                }));
                $(".profile-items").empty();
    ...
    $('#incidents-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (incident !== "") {
                canSearchForProfiles = false
                $.post('https://pw-mdt/searchIncidents', JSON.stringify({
                    incident: incident
                }));
    ...
    $('#dispatchmsg').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            e.preventDefault()
            const time = new Date()
            $.post('https://pw-mdt/dispatchMessage', JSON.stringify({
                message: $(this).val(),
                time: time.getTime()
            }));
            $(this).val("")
    ...
    $(".incidents-items").on("click", ".incidents-item", function () {
        ...
        $.post('https://pw-mdt/getIncidentData', JSON.stringify({
            id: id
        }));
    })
    ...
    document.onkeyup = function (data) {
        if (data.which == 27) {
            ...
            if (shouldClose == true) {
                $.post('https://pw-mdt/escape', JSON.stringify({}));
            }
        }
    };
    ...
    $(".icidents-person-search-name-input").on("keydown", "", function (e) {
        if (e.keyCode === 13) {
            ...
            $.post('https://pw-mdt/incidentSearchPerson', JSON.stringify({
                name: name
            }));
        }
    });
    ...
    $(".manage-bolos-title-holder").on("click", ".manage-bolos-save", function () {
        ...
        $.post('https://pw-mdt/newBolo', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            plate: plate,
    ...
    $('#bolos-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (searchVal !== "") {
                canSearchForProfiles = false
                $.post('https://pw-mdt/searchBolos', JSON.stringify({
                    searchVal: searchVal
                }));
                $(".bolos-items").empty();
    ...
    $(".bolos-search-refresh").click(function () {
        if (canRefreshBolo == true) {
            ...
            setTimeout(() => {
                ...
                canRefreshBolo = true
                $.post('https://pw-mdt/getAllBolos', JSON.stringify({}));
            }, 1500);
        }
    });
    ...
    $(".bolos-items").on("click", ".bolo-item", function () {
        ...
        canInputBoloOfficerTag = true
        let id = $(this).data("id");
        $.post('https://pw-mdt/getBoloData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".contextmenu").on("click", ".bolo-delete", function () {
        ...
        if ($(this).data("info") != 0) {
            if ($(".badge-logo").attr('src') == 'https://cdn.discordapp.com/attachments/770324167894761522/912602342275301396/ems_badge.png') {
                ...
                $.post('https://pw-mdt/deleteICU', JSON.stringify({
                    id: $(this).data("info"),
                    time: new Date().getTime()
                }));
            }
            $(".bolos-items").find("[data-id='" + $(this).data("info") + "']").remove();
            $.post('https://pw-mdt/deleteBolo', JSON.stringify({
                id: $(this).data("info"),
                time: new Date().getTime()
            }));
        }
    ...
    $(".contextmenu").on("click", ".incident-delete", function () {
        ...
        $.post('https://pw-mdt/deleteIncident', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".missing-delete", function () {
        ...
        $.post('https://pw-mdt/deleteMissing', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".profile-missing", function () {
        $.post('https://pw-mdt/missingCitizen', JSON.stringify({
            cid: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".report-delete", function () {
        ...
        $.post('https://pw-mdt/deleteReport', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".add-charge", function () {
        ...
        $.post('https://pw-mdt/getPenalCode', JSON.stringify({}));
    });
    ...
    $(".contextmenu").on("click", ".associated-incidents-remove-tag", function () {
        ...
        if (incidentId != 0) {
            $.post('https://pw-mdt/removeIncidentCriminal', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".incidents-remove-normal-tag", function () {
        ...
        let cid = $(".manage-profile-citizenid-input").val();
        if (cid) {
            $.post('https://pw-mdt/removeProfileTag', JSON.stringify({
                cid: cid,
                text: $(this).data("info")
            }));
        }
    ...
    $(".reports-search-refresh").click(function () {
        if (canRefreshReports == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://pw-mdt/getAllReports', JSON.stringify({}));
            }, 1500);
        }
    });
    $(".dispatch-comms-refresh").click(function () {
        ...
        setTimeout(() => {
            ...
            canRefreshReports = true
            $.post('https://pw-mdt/refreshDispatchMsgs', JSON.stringify({}));
        }, 1500);
    })
    $(".reports-items").on("click", ".reports-item", function () {
        ...
        let id = $(this).data("id");
        $.post('https://pw-mdt/getReportData', JSON.stringify({
            id: id
        }));
    })
    ...
    $('#reports-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForReports == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://pw-mdt/searchReports', JSON.stringify({
                    name: name
                }));
                $(".reports-items").empty();
    ...
    $(".manage-reports-title-holder").on("click", ".manage-reports-save", function () {
        ...
        $.post('https://pw-mdt/newReport', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            type: type,
    ...
    $('#missing-search-input').keydown(function (e) {
        if (e.keyCode === 13) {
            ...
            if (name !== "") {
                $.post('https://pw-mdt/searchMissing', JSON.stringify({
                    name: name
                }));
                $(".missing-items").empty();
    ...
    $(".missing-items").on("click", ".missing-item", function () {
        $.post('https://pw-mdt/getMissingData', JSON.stringify({
            id: $(this).data("dbid")
        }));
    });
    ...
    $(".vehicle-information-title-holder").on("click", ".vehicle-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://pw-mdt/saveVehicleInfo', JSON.stringify({
                    dbid: dbid,
                    plate: plate,
                    imageurl: imageurl,
                    notes: notes
    ...
    $(".weapon-information-title-holder").on("click", ".weapon-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://pw-mdt/saveWeaponInfo', JSON.stringify({
                    dbid: dbid,
    ...
    $(".missing-information-title-holder").on("click", ".missing-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://pw-mdt/saveMissingInfo', JSON.stringify({
                    id: dbid,
                    last_seen: last_seen,
                    imageurl: imageurl,
                    notes: notes
    ...
    $(".contextmenu").on("click", ".mark-code-5", function () {
        ...
        if (tag.hasClass("red-tag")) {
            ...
            $.post('https://pw-mdt/knownInformation', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".toggle-duty", function () {
        ...
        if (currentStatus == "10-8") {
            ...
            $.post('https://pw-mdt/toggleDuty', JSON.stringify({
                cid: info,
                status: 0
            }));
    ...
    $(".contextmenu").on("click", ".set-waypoint", function () {
        let info = $(this).data("info")
        $.post('https://pw-mdt/setWaypointU', JSON.stringify({
            cid: info,
        }));
    })
    ...
    $(".contextmenu").on("click", ".set-waypoint", function () {
        ...
        $.post('https://pw-mdt/setWaypoint', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-attach", function () {
        const callId = $(this).data("info")
        $.post('https://pw-mdt/callAttach', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-detach", function () {
        const callId = $(this).data("info")
        $.post('https://pw-mdt/callDetach', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".remove-call", function () {
        ...
        $.post('https://pw-mdt/removeCall', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".attached-units", function () {
        const callId = $(this).data("info")
        $.post('https://pw-mdt/attachedUnits', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $('#respondcalls').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            ...
            e.preventDefault();
            const time = new Date()
            $.post('https://pw-mdt/sendCallResponse', JSON.stringify({
                message: $(this).val(),
                time: time.getTime(),
                callid: callid
            }));
    ...
    $(".contextmenu").on("click", ".respond-call", function () {
        const callId = $(this).data("info")
        $.post('https://pw-mdt/getCallResponses', JSON.stringify({
            callid: callId
        }));
    ...
    $(".contextmenu").on("click", ".call-dispatch-detach", function () {
        const cid = $(this).data("info")
        $.post('https://pw-mdt/callDispatchDetach', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".Set-Dispatch-Waypoint", function () {
        const cid = $(this).data("info")
        $.post('https://pw-mdt/setDispatchWaypoint', JSON.stringify({
            callid: $(".dispatch-attached-units-container").attr("id"),
            cid: cid
        }));
    })
    ...
    $(".jail-buttons").on("click", ".jail-submit", function () {
        ...
        if (time.length > 0) {
            ...
            $.post('https://pw-mdt/jailPlayer', JSON.stringify({
                cid: cid,
                time: time
            }));
            $(".jail-inner-container").slideUp(500)
    ...
    $(".dna-buttons").on("click", ".dna-submit", function () {
        ...
        if (dna.length == 7) {
            ...
            $.post('https://pw-mdt/dnaEdit', JSON.stringify({
                cid: cid,
                dna: dna
            }));
            $(".dna-inner-container").slideUp(500)
    ...
    $(".callsign-buttons").on("click", ".callsign-submit", function () {
        ...
        if (callsign.length > 2) {
            ...
            $.post('https://pw-mdt/setCallsign', JSON.stringify({
                cid: editingcallsign,
    ...
    $(".active-calls-list").on("click", ".active-calls-item", function (e) {
        ...
        if (callId && draggedElement) {
            $.post('https://pw-mdt/callDragAttach', JSON.stringify({
                callid: callId,
                cid: draggedElement
            }));
            draggedElement = 0
    ...
    function JobColors(sentJob) {
        ...
        if (sentJob) {
            ...
            if (["police", "sheriff", "state_police", "park_ranger", "cid"].includes(sentJob)) {
                ...
                $(".header-title").html("Perfect World Police Department");
                ...
                $(".manage-bolos-editing-title").html("Bạn đang tạo một BOLO mới");
                $(".boloplate-title").html("Biển Số");
                $(".boloowner-title").html("Chủ sở hữu");
                $(".boloindividual-title").html("Loại hình");
                $("#boloplate").attr('placeholder', 'Biển số ở đây...');
                $("#bolodetail").attr('placeholder', 'Nội dung BOLO mới...');
                $("#boloowner").attr('placeholder', 'Tên chủ sở hữu...');
                ...
                $("#incidents-search-input").attr('placeholder', 'Tìm kiếm hồ sơ...');
                $(".manage-incidents-reports-content").attr('placeholder', 'Thông tin hồ sơ...');
                $(".manage-incidents-title").html("Chỉnh Sửa Hồ Sơ");
                $(".manage-incidents-editing-title").html("Tạo Hồ Sơ Mới");
                $(".manage-incidents-officeun-title").html("Bác Sĩ Có Liên Quan");
                $(".manage-incidents-evidence-title").html("Hình ảnh");
                $(".associated-incidents-tags-title").html("Bệnh Nhân Có Liên Quan");

                $("#reports-officeun-involved-tag-title").html("Bác Sĩ Có Liên Quan")
    ...
    window.addEventListener('message', function (event) {
        ...
        if (e.type == "show") {
            ...
            $.post('https://pw-mdt/getAllProfiles', JSON.stringify({}));
        } else if (e.type == "data") {
            ...
            if ((BodyDisplay) == "block") {
                ...
                $.post('https://pw-mdt/dispatchNotif', JSON.stringify({
                    data: value,
                }));
            }
            $('.dispatch-items').scrollTop($('.dispatch-items')[0].scrollHeight)
            ...
            if ($(".respond-calls-container").data("id") == e.callid) {
                $(".respond-calls-responses").prepend(`<div class="respond-calls-response"> ${e['name']} đã gửi "${e['message']}" - ${timeAgo(Number(e.time))}. </div>`)
            }
            ...
            $.each(table, function (index, value) {
                $(".respond-calls-responses").prepend(`<div class="respond-calls-response"> ${value['name']} đã gửi "${value['message']}" - ${timeAgo(Number(value.time))}. </div>`)
            })
            ...
            $.each(table, function (index, value) {
                if (value) {
                    ...
                    if (value.dispatchCode == "911" || value.dispatchCode == "311" || value.dispatchCode == "10-52") {
                        DispatchItem = `<div class="active-calls-item" data-id="${value.callId}" data-canrespond="true"><div class="active-call-inner-container"><div class="call-item-top"><div class="call-number">#${value.callId}</div><div class="call-code priority-${value.priority}">${value.dispatchCode}</div><div class="call-title">${value.dispatchMessage}</div><div class="call-radio">${value.units.length}</div></div><div class="call-item-bottom">`
                    }
            ...
            $.each(table, function (index, value) {
                $('.incidents-items').prepend(
                    ...
                    <div class="incidents-top-holder">
                        ...
                        <div class="incedent-report-name">Báo cáo sự cố</div>
                    </div>
                ...
                <div class="missing-item" data-id="${value.id}" data-dbid="${value.id}" data-cid="${value.cid}">
                    ...
                    <div style="display: flex; flex-direction: column;">
                        ...
                        <div class="missing-bottom-info">
                            <div class="missing-id">ID: ${value.id} · Nhìn thấy lần cuối: ${value.last_seen}</div>
                        </div>
                    </div>
                </div>
                `)
                    ...
                    <div style="display: flex; flex-direction: column;">
                        <div class="dmv-item-title">${value.model}</div>
                            <div class="dmv-tags">
                                ...
                                <div class="dmv-tag ${impound}">Bị Giam</div>
                                <div class="dmv-tag ${bolo}">BOLO</div>
                                <div class="dmv-tag ${stolen}">Mất Trộm</div>
                                <div class="dmv-tag ${code5}">Code 5</div>
                            </div>
                        </div>
                        <div class="dmv-bottom-info">
                            <div class="dmv-id">ID: ${value.id} · Chủ sở hữu: ${value.owner}</div>
                        </div>
                    </div>
                </div>
                `)
                ...
                <div class="weapon-item" data-id="${value.id}" data-dbid="${value.id}" data-plate="${value.serial}">
                    ...
                    <div style="display: flex; flex-direction: column;">
                        ...
                        <div class="weapon-bottom-info">
                            <div class="weapon-id">ID: ${value.id} · Chủ sở hữu: ${value.owner}</div>
                        </div>
                    </div>
                </div>
                `)
...
function fidgetSpinner(page) {
    ...
    if (page == '.missing-page-container') {
        $.post('https://pw-mdt/getAllMissing', JSON.stringify({}));
    }
    if (page == '.reports-page-container') {
        $.post('https://pw-mdt/getAllReports', JSON.stringify({}));
    }
    if (page == '.stafflogs-page-container') {
        $.post('https://pw-mdt/getAllLogs', JSON.stringify({}));
    }
    if (page == '.incidents-page-container') {
        $.post('https://pw-mdt/getAllIncidents', JSON.stringify({}));
    }
    if (page == '.dmv-page-container') {
        $.post('https://pw-mdt/getAllVehicles', JSON.stringify({}));
    }
    if (page == '.weapons-page-container') {
        $.post('https://pw-mdt/getAllWeapons', JSON.stringify({}));
    }
...
function addTag(tagInput) {
    ...
    $.post('https://pw-mdt/newTag', JSON.stringify({
...
function addWeapon(Input) {
    ...
    $.post('https://pw-mdt/newWeapon', JSON.stringify({
        id: $(".manage-profile-citizenid-input").val(),
        serialnumber: Input
    }));
}
...
function removeImage(url) {
    ...
    $.post('https://pw-mdt/removeGalleryImg', JSON.stringify({
        cid: cid,
        URL: url
    }));
}

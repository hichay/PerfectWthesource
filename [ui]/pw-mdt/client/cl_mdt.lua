...
function EnableGUI(enable)
    ...
    if enable then
        ...
        SendNUIMessage({type = "dispatchmessages", data = RPC.execute("pw-mdt:dashboardMessages")})
        local police, sheriff, state_police, park_ranger, ems, doj = RPC.execute("pw-mdt:getActiveUnits")
        ...
        SendNUIMessage({type = "UpdateEMSRoster", data = "https://docs.google.com/spreadsheets/d/e/2PACX-1vTrVQF_Wx6FezBcdsYPfY85KMshLzNwyWkLwTNTsFlWI-2MM2xDCLX3IykF76tOtYlwi8LQkNcwiy-x/pubhtml"})
        SendNUIMessage({type = "warrants", data = RPC.execute("pw-mdt:getWarrants")})
        SendNUIMessage({type = "calls", data = RPC.execute("pw-mdt:getCalls")})
    end
...
AddEventHandler("pw-mdt:publicRecords", function()
    isOpen = true
    ...
    SendNUIMessage({
        type = "data",
        name = "Xin chào, " .. fullName,
        location = playerStreetsLocation,
        fullname = fullName
    })
end)

RegisterCommand("openmdt", function(source, args, rawCommand)
    TriggerEvent('pw-mdt:open')
end, false)

RegisterNetEvent("pw-mdt:open")
AddEventHandler("pw-mdt:open", function()
    open = true
    EnableGUI(open)
...
AddEventHandler("pw-mdt:animation", function()
...
RegisterNetEvent("pw-mdt:exitMDT")
AddEventHandler("pw-mdt:exitMDT", function()
    open = false
    EnableGUI(open)
end)
...
RegisterNetEvent("pw-mdt:dashboardbulletin")
AddEventHandler("pw-mdt:dashboardbulletin", function(sentData)
    SendNUIMessage({
        type = "bulletin",
        data = sentData
    })
...
RegisterNUICallback("newBulletin", function(data, cb)
    TriggerServerEvent("pw-mdt:newBulletin", data.title, data.info, data.time)
    cb(true)
end)

RegisterNetEvent("pw-mdt:newBulletin")
...
RegisterNUICallback("deleteBulletin", function(data, cb)
    TriggerServerEvent("pw-mdt:deleteBulletin", data.id)
    cb(true)
end)

RegisterNetEvent("pw-mdt:deleteBulletin")
AddEventHandler("pw-mdt:deleteBulletin", function(ignoreId, sentData, job)
...
RegisterNetEvent("pw-mdt:dashboardMessages")
AddEventHandler("pw-mdt:dashboardMessages", function(sentData)
    SendNUIMessage({
...
RegisterNUICallback("refreshDispatchMsgs", function(data, cb)
    TriggerServerEvent("pw-mdt:refreshDispatchMsgs")
    cb(true)
end)

RegisterNUICallback("dispatchMessage", function(data, cb)
    TriggerServerEvent("pw-mdt:sendMessage", data.message, data.time)
    cb(true)
end)
...
RegisterNetEvent("pw-mdt:getActiveUnits")
AddEventHandler("pw-mdt:getActiveUnits", function(police, bcso, sahp, sasp, doc, sapr, pa, ems)
    SendNUIMessage({
        type = "getActiveUnits",
        police = police,
        bcso = bcso,
...
RegisterNUICallback("setWaypointU", function(data, cb)
    TriggerServerEvent("pw-mdt:setWaypoint:unit", data.cid)
    cb(true)
end)

RegisterNetEvent("pw-mdt:setWaypoint:unit")
AddEventHandler("pw-mdt:setWaypoint:unit", function(sentData)
    TriggerEvent("DoLongHudText", "GPS marked!")
    SetNewWaypoint(sentData.x, sentData.y)
end)

RegisterNUICallback("setRadio", function(data, cb)
    TriggerServerEvent("pw-mdt:setRadioTo", data.cid, data.newradio)
    cb(true)
end)


RegisterNetEvent('pw-mdt:setRadio')
AddEventHandler('pw-mdt:setRadio', function(radio, name)
    if radio then
        if (not exports["pw-inventory"]:hasEnoughOfItem("radio",1,false) and not exports["pw-inventory"]:hasEnoughOfItem("pdradio",1,false)) then
...
RegisterNUICallback("setCallsign", function(data, cb)
    TriggerServerEvent("pw-mdt:setCallsign", data.cid, data.newcallsign)
    cb(true)
end)

RegisterNUICallback("toggleDuty", function(data, cb)
    -- TriggerServerEvent("pw-mdt:toggleDuty", data.cid, data.status)
    cb(true)
end)
...
RegisterNUICallback("removeCall", function(data, cb)
    TriggerServerEvent("pw-mdt:removeCall", data.callid)
...
RegisterNUICallback("setWaypoint", function(data, cb)
    local call = RPC.execute("pw-dispatch:getCall", data.callid)
...
RegisterNUICallback("callAttach", function(data, cb)
    TriggerServerEvent("pw-mdt:callAttach", data.callid)
...
RegisterNUICallback("callDetach", function(data, cb)
    TriggerServerEvent("pw-mdt:callDetach", data.callid)
...
RegisterNUICallback("attachedUnits", function(data, cb)
    local units, callid = RPC.execute("pw-mdt:attachedUnits", data.callid)
...
RegisterNUICallback("callDragAttach", function(data, cb)
    TriggerServerEvent("pw-mdt:callDragAttach", data.callid, data.cid)

    cb(true)
end)

RegisterNUICallback("callDispatchDetach", function(data, cb)
    TriggerServerEvent("pw-mdt:callDispatchDetach", tonumber(data.callid), tonumber(data.cid))

    cb(true)
end)

RegisterNUICallback("setDispatchWaypoint", function(data, cb)
    TriggerServerEvent("pw-mdt:setDispatchWaypoint", tonumber(data.callid), tonumber(data.cid))
...
RegisterNUICallback("getCallResponses", function(data, cb)
    TriggerServerEvent("pw-mdt:getCallResponses", data.callid)

    cb(true)
end)

RegisterNetEvent("pw-mdt:getCallResponses")
AddEventHandler("pw-mdt:getCallResponses", function(sentData, sentCallId)
    SendNUIMessage({
...
RegisterNUICallback("sendCallResponse", function(data, cb)
    TriggerServerEvent("pw-mdt:sendCallResponse", data.message, data.time, data.callid)

    cb(true)
end)

RegisterNetEvent("pw-mdt:sendCallResponse")
...
RegisterNetEvent("pw-mdt:dashboardWarrants")
AddEventHandler("pw-mdt:dashboardWarrants", function(sentData)
    SendNUIMessage({
        type = "warrants",
        data = sentData
    })
...
RegisterNUICallback("getAllProfiles", function(data, cb)
    ...
    SendNUIMessage({
        type = "profiles",
        data = RPC.execute("pw-mdt:searchProfile", ""),
...
RegisterNUICallback("searchProfiles", function(data, cb)
    ...
    SendNUIMessage({
        type = "profiles",
        data = RPC.execute("pw-mdt:searchProfile", data.name),
        isLimited = (is_police == false and is_doj == false)
    })
...
RegisterNUICallback("saveProfile", function(data, cb)
    TriggerServerEvent("pw-mdt:saveProfile", data.pfp, data.description, data.id, data.fName, data.sName)
    cb(true)
end)

RegisterNUICallback("updateLicence", function(data, cb)
    TriggerServerEvent("pw-mdt:updateLicense", data.cid, data.type, data.status)
    cb(true)
end)

RegisterNUICallback("newTag", function(data, cb)
    TriggerServerEvent("pw-mdt:newTag", data.id, data.tag)
    cb(true)
end)

RegisterNUICallback("removeProfileTag", function(data, cb)
    TriggerServerEvent("pw-mdt:removeProfileTag", data.cid, data.text)
    cb(true)
end)

RegisterNUICallback("addGalleryImg", function(data, cb)
    TriggerServerEvent("pw-mdt:addGalleryImg", data.cid, data.URL)
    cb(true)
end)

RegisterNUICallback("removeGalleryImg", function(data, cb)
    TriggerServerEvent("pw-mdt:removeGalleryImg", data.cid, data.URL)
    cb(true)
end)

RegisterNUICallback("searchHouse", function(data, cb)
    local houseInfo = exports["pw-housing"]:getHouse(data.house_id)
    TriggerEvent("DoLongHudText", "GPS marcado!")
...
RegisterNUICallback("dnaEdit", function(data, cb)
    TriggerServerEvent("pw-mdt:dnaEdit", data.cid, data.dna)
...
RegisterNUICallback("getAllIncidents", function(data, cb)
    SendNUIMessage({
        type = "incidents",
        data = RPC.execute("pw-mdt:getAllIncidents")
    })
...
RegisterNUICallback("searchIncidents", function(data, cb)
    SendNUIMessage({
        type = "incidents",
        data = RPC.execute("pw-mdt:searchIncidents", data.incident)
    })
...
RegisterNUICallback("getIncidentData", function(data, cb)
    local sentData, sentConvictions = RPC.execute("pw-mdt:getIncidentData", data.id)
...
RegisterNUICallback("incidentSearchPerson", function(data, cb)
    SendNUIMessage({
        ...
        data = RPC.execute("pw-mdt:incidentSearchPerson", data.name)
    })
...
RegisterNUICallback("getPenalCode", function(data, cb)
    local titles, penalcode, job = RPC.execute("pw-mdt:getPenalCode")
...
RegisterNUICallback("saveIncident", function(data, cb)
    TriggerServerEvent("pw-mdt:saveIncident", data)
    cb(true)
end)

RegisterNUICallback("removeIncidentCriminal", function(data, cb)
    TriggerServerEvent("pw-mdt:removeIncidentCriminal", data.cid, data.incidentId)
    cb(true)
end)

RegisterNUICallback("deleteIncident", function(data, cb)
    TriggerServerEvent("pw-mdt:deleteIncident", data.id, data.time)
end)
...
RegisterNUICallback("getAllReports", function(data, cb)
    SendNUIMessage({
        type = "reports",
        data = RPC.execute("pw-mdt:searchReports", "")
    })
...
RegisterNUICallback("searchReports", function(data, cb)
    SendNUIMessage({
        type = "reports",
        data = RPC.execute("pw-mdt:searchReports", data.name)
    })
...
RegisterNUICallback("getReportData", function(data, cb)
    SendNUIMessage({
        type = "reportData",
        data = RPC.execute("pw-mdt:getReportData", data.id)
    })
...
RegisterNUICallback("newReport", function(data, cb)
    TriggerServerEvent("pw-mdt:newReport", data)
    cb(true)
end)

RegisterNetEvent("pw-mdt:reportComplete")
AddEventHandler("pw-mdt:reportComplete", function(sentData)
    SendNUIMessage({
        type = "reportComplete",
        data = sentData
    })
...
RegisterNUICallback("deleteReport", function(data, cb)
    TriggerServerEvent("pw-mdt:deleteReport", data.id, data.time)
end)

RegisterNUICallback("getAllBolos", function(data, cb)
    SendNUIMessage({
        type = "bolos",
        data = RPC.execute("pw-mdt:searchBolos", "")
    })
...
RegisterNUICallback("searchBolos", function(data, cb)
    SendNUIMessage({
        type = "bolos",
        data = RPC.execute("pw-mdt:searchBolos", data.searchVal)
    })
...
RegisterNUICallback("getBoloData", function(data, cb)
    SendNUIMessage({
        type = "boloData",
        data = RPC.execute("pw-mdt:getBoloData", data.id)
    })
...
RegisterNUICallback("newBolo", function(data, cb)
    TriggerServerEvent("pw-mdt:newBolo", data)
    cb(true)
end)

RegisterNetEvent("pw-mdt:boloComplete", function(sentData)
    SendNUIMessage({
        type = "boloComplete",
        data = sentData
    })
...
RegisterNUICallback("deleteBolo", function(data, cb)
    TriggerServerEvent("pw-mdt:deleteBolo", data.id)
    cb(true)
end)

RegisterNUICallback("deleteICU", function(data, cb)
    TriggerServerEvent("pw-mdt:deleteICU", data.id)
    cb(true)
end)
...
RegisterNUICallback("searchVehicles", function(data, cb)
    local sentData = RPC.execute("pw-mdt:searchVehicles", data.name)
...
RegisterNUICallback("getVehicleData", function(data, cb)
    local sentData = RPC.execute("pw-mdt:getVehicleData", data.plate)
...
RegisterNUICallback("saveVehicleInfo", function(data, cb)
    TriggerServerEvent("pw-mdt:saveVehicleInfo", data.dbid, data.plate, data.imageurl, data.notes)

    cb(true)
end)

RegisterNUICallback("knownInformation", function(data, cb)
    TriggerServerEvent("pw-mdt:knownInformation", data.dbid, data.type, data.status, data.plate)
...
RegisterNUICallback("getAllWeapons", function(data, cb)
    local sentData = RPC.execute("pw-mdt:searchWeapon", "")
...
RegisterNUICallback("searchWeapon", function(data, cb)
    local sentData = RPC.execute("pw-mdt:searchWeapon", data.name)
...
RegisterNUICallback("getWeaponData", function(data, cb)
    local sentData = RPC.execute("pw-mdt:getWeaponData", data.serialnumber)
...
RegisterNUICallback("newWeapon", function(data, cb)
    TriggerServerEvent("pw-mdt:addWeapon", data.id, data.serialnumber)

    cb(true)
end)

RegisterNUICallback("saveWeaponInfo", function(data, cb)
    TriggerServerEvent("pw-mdt:saveWeapon", data.serialnumber, data.imageurl, data.brand, data.type, data.notes)
...
RegisterNUICallback("getAllMissing", function(data, cb)
    local sentData = RPC.execute("pw-mdt:searchMissing", "")
...
RegisterNUICallback("searchMissing", function(data, cb)
    local sentData = RPC.execute("pw-mdt:searchMissing", data.name)
...
RegisterNUICallback("getMissingData", function(data, cb)
    local sentData = RPC.execute("pw-mdt:getMissingData", data.id)
...
RegisterNUICallback("missingCitizen", function(data, cb)
    TriggerServerEvent("pw-mdt:missingCitizen", data.cid, data.time)

    cb(true)
end)

RegisterNUICallback("saveMissingInfo", function(data, cb)
    TriggerServerEvent("pw-mdt:saveMissing", data.id, data.last_seen, data.imageurl, data.notes)

    cb(true)
end)

RegisterNUICallback("deleteMissing", function(data, cb)
    TriggerServerEvent("pw-mdt:deleteMissing", data.id, data.time)
...
RegisterNUICallback("getAllLogs", function(data, cb)
    SendNUIMessage({
        type = "getAllLogs",
        data = RPC.execute("pw-mdt:getAllLogs")
    })

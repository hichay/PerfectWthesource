...
AddEventHandler("pw-meth:showSellDrugsMenuItem", function(type, b)
    if type == "cancorner" then
        canStartCornering = b
    end
end)

AddEventHandler("pw-polyzone:enter", function(name)
    if name == "meth_corner" then
        showSellMethOption = true
    end
end)
AddEventHandler("pw-polyzone:exit", function(name)
    if name == "meth_corner" then
...
Citizen.CreateThread(function()
    GeneralEntries[#GeneralEntries+1] = {
        data = {
            ...
            icon = "#walking",
            title = "Sell",
            event = "pw-meth:cornerSellProduct",
        },
        isEnabled = function()
    ...
    GeneralEntries[#GeneralEntries+1] = {
        data = {
            ...
            icon = "#walking",
            title = "Corner",
            event = "pw-meth:cornerStartSelling",
        },
        isEnabled = function()
...
--     {
--         data = {
--             id = 'pw-meth:startCooking',
--             title = "Start Cooking",
--             icon = "#police-check",
--             event = "pw-meth:startCooking",
--         },
--         isEnabled = checkObject("computer"),
--     },
--     {
--         data = {
--             id = 'pw-meth:adjustFridgeTemp',
--             title = "Adjust Temperature",
--             icon = "#police-check",
--             event = "pw-meth:adjustFridgeTemp",
--         },
--         isEnabled = checkObject("fridge"),
--     },
--     {
--         data = {
--             id = 'pw-meth:adjustSteamLevel',
--             title = "Adjust Levels",
--             icon = "#police-check",
--             event = "pw-meth:adjustSteamLevel",
--         },
--         isEnabled = checkObject("distil"),
--     },
--     {
--         data = {
--             id = 'pw-meth:adjustDistilSettings',
--             title = "Adjust Settings",
--             icon = "#police-check",
--             event = "pw-meth:adjustDistilSettings",
--         },
--         isEnabled = checkObject("distil"),
--     },
--     {
--         data = {
--             id = 'pw-meth:adjustMixerTemp',
--             title = "Adjust Temperature",
--             icon = "#police-check",
--             event = "pw-meth:adjustMixerTemp",
--         },
--         isEnabled = checkObject("mixer_temperature"),
--     },
--     {
--         data = {
--             id = 'pw-meth:addIngredient',
--             title = "Add Ingredient",
--             icon = "#police-check",
--             event = "pw-meth:addIngredient",
--         },
--         isEnabled = checkObject("mixer_drop"),
--     },
--     {
--         data = {
--             id = 'pw-meth:adjustMixerSettings',
--             title = "Adjust Settings",
--             icon = "#police-check",
--             event = "pw-meth:adjustMixerSettings",
--         },
--         isEnabled = checkObject("mixer_settings"),
--     },
--     {
--         data = {
--             id = 'pw-meth:pickupIngredient',
--             title = "Pickup",
--             icon = "#police-check",
--             event = "pw-meth:pickupIngredient",
--         },

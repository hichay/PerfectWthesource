WeaponNames = {
			   [tostring(GetHashKey('WEAPON_UNARMED'))] = 'Tay không',
			   [tostring(GetHashKey('WEAPON_KNIFE'))] = 'Dao',
			   [tostring(GetHashKey('WEAPON_NIGHTSTICK'))] = 'Nightstick',
			   [tostring(GetHashKey('WEAPON_HAMMER'))] = 'Búa',
			   [tostring(GetHashKey('WEAPON_BAT'))] = 'Gậy bóng chày',
			   [tostring(GetHashKey('WEAPON_GOLFCLUB'))] = 'Gậy gofl',
			   [tostring(GetHashKey('WEAPON_CROWBAR'))] = 'Xà beng',
			   [tostring(GetHashKey('WEAPON_PISTOL'))] = 'Súng lục',
			   ...
			   [tostring(GetHashKey('WEAPON_HELI_CRASH'))] = 'Rớt máy bay trực thăng',
			   [tostring(GetHashKey('WEAPON_RUN_OVER_BY_CAR'))] = 'Xe cán',
			   [tostring(GetHashKey('WEAPON_HIT_BY_WATER_CANNON'))] = 'Hit by Water Cannon',
			   [tostring(GetHashKey('WEAPON_EXHAUSTION'))] = 'Kiệt sức',
			   [tostring(GetHashKey('WEAPON_EXPLOSION'))] = 'Nổ tung',
			   [tostring(GetHashKey('WEAPON_ELECTRIC_FENCE'))] = 'Electric Fence',
			   [tostring(GetHashKey('WEAPON_BLEEDING'))] = 'Chảy máu',
			   [tostring(GetHashKey('WEAPON_DROWNING_IN_VEHICLE'))] = 'Chết đuối trong xe',
			   [tostring(GetHashKey('WEAPON_DROWNING'))] = 'Chết đuối',
			   ...
			   [tostring(GetHashKey('WEAPON_WRENCH'))] = 'Cờ lê',
			   [tostring(GetHashKey('WEAPON_SNOWBALL'))] = 'Snowball',
			   [tostring(GetHashKey('WEAPON_ANIMAL'))] = 'Thú',
			   [tostring(GetHashKey('WEAPON_COUGAR'))] = 'Báo hoặc sử tử'
			  }

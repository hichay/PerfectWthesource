...
m.messages = {   
    '^_ ^3 Hãy chơi một cách văn minh và đúng luật - Mọi hành vi bug/cheat đều bị nghiêm cấm',
    '^_ ^3 Luật là thứ làm nên một server. Vì thế hãy tuân thủ luật để trải nghiêm game một cách tốt nhất',
    '^_ ^3 Discord server:discord.gg/9kag3uK - chúng tôi luôn tiếp nhận đóng góp để phát triển server tốt hơn',
}

...
RegisterCommand("nocliptest", function(source, args, rawCommand)
	toggle = not toggle
	TriggerEvent('caue-admin:noClipToggle',toggle)

	
end, false)

RegisterCommand("nocliptestof", function(source, args, rawCommand)
	local toggle = false

		TriggerEvent('caue-admin:noClipToggle',false)

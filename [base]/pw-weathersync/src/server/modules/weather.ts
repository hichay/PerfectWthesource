...
setInterval(() => {
    ...
    emitNet("pw-weathersync:client:weather", -1, currentWeather)
    emitNet("pw-weathersync:currentWeather", -1, currentWeather.weather)
}, timePerWeather * 1000)

onNet("pw-weathersync:client:weather:request", () => {
    emitNet("pw-weathersync:client:weather", global.source, weatherProgression[0])
    emitNet("pw-weathersync:currentWeather", global.source, weatherProgression[0].weather)
})

onNet("pw-weathersync:setWeather", (source: string, param: string) => {
    ...
    emitNet("pw-weathersync:client:weather", -1, weatherProgression[0])
    emitNet("pw-weathersync:currentWeather", -1, weatherProgression[0].weather)
})

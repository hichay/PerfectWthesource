function CreateExtendedPlayer(playerId, identifier, group, accounts, inventory, weight, job, loadout, name, coords, id)
	local self = {}
	...
	-- self.addInventoryItem = function(name, count)
		...
		-- -- if item then
			...
			-- self.triggerEvent('player:receiveItem', name, count)
		-- -- end
	-- end
	self.addInventoryItem = function(name, count,info)
		local item = self.getInventoryItem(name)
		...
		-- if item then
			...
			-- TriggerEvent('esx:onAddInventoryItem', self.source, item.name, item.count)
			-- self.triggerEvent('esx:addInventoryItem', item.name, item.count, false, item)
			self.triggerEvent('player:receiveItem', name, count, true, true, info)
		-- end
	end

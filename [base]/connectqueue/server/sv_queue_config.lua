...
-- simple localization
Config.Language = {
    joining = "\xF0\x9F\x8E\x89Da hoan tat...",
    connecting = "\xE2\x8F\xB3Dang tai thong tin nhan vat...",
    idrr = "\xE2\x9D\x97[Queue] Error: Couldn't retrieve any of your id's, try restarting.",
    err = "\xE2\x9D\x97[Queue] There was an error",
    pos = "\xF0\x9F\x90\x8CBan dang o hang cho %d/%d con lai \xF0\x9F\x95\x9C%s",

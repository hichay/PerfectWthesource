...
Config.Weapons = {
...

	{
		...
		components = {
			...
			{name = 'd_orbit', label = 'Orbit Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_ORBIT'), is_skin = true},
			{name = 'd_amarine', label = 'Aqua Marine Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_AMARINE'), is_skin = true},
			{name = 'd_eliteb', label = 'ELITE BUILD Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_ELITEBUILD'), is_skin = true},
			{name = 'd_frontsi', label = 'Frontside Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_FRONTSIDEM'), is_skin = true},
			{name = 'd_jaguar', label = 'Jaguar Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_JAGUAR'), is_skin = true},
			{name = 'd_rebel', label = 'Wasteland Rebel Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_REBEL'), is_skin = true},
			{name = 'd_vulkan', label = 'Vulkan Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_VULKAN'), is_skin = true},
			
			{name = 'd_assimov', label = 'Assimov Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_ASSIMOV'), is_skin = true},
			{name = 'd_blacklam', label = 'Black Laminate Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_BLACKLAMINATE'), is_skin = true},
			{name = 'd_bloods', label = 'Bloodsport Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_BLOODSPORT'), is_skin = true},
			{name = 'd_cartel', label = 'Cartel Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_CARTEL'), is_skin = true},
			{name = 'd_casehard', label = 'Case Hardened Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_CASEHARDENED'), is_skin = true},
			{name = 'd_emeral', label = 'Emeral Prinstripe Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_EMERALDPINSTRIPE'), is_skin = true},
			{name = 'd_empr', label = 'Empress Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_EMPRESS'), is_skin = true},
			{name = 'd_firesp', label = 'Fire Serpent Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_FIRESERPENT'), is_skin = true},
			{name = 'd_firstcl', label = 'First Class Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_FIRSTCLASS'), is_skin = true},
			{name = 'd_fuelinj', label = 'Fuel Injector Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_FUELINJECTOR'), is_skin = true},
			{name = 'd_hydro', label = 'Hydroponic Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_HYDROPONIC'), is_skin = true},
			{name = 'd_jetset', label = 'Jet Set Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_JETSET'), is_skin = true},
			{name = 'd_neonrevo', label = 'Neon Revolution Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_NEONREVOLUTION'), is_skin = true},
			{name = 'd_neonrai', label = 'neon Raider Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_NEONRAIDER'), is_skin = true},
			{name = 'd_pointdis', label = 'Point Disarray Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_POINTDISARRAY'), is_skin = true},
			{name = 'd_predator', label = 'Predator Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_PREDATOR'), is_skin = true},
			{name = 'd_redlam', label = 'Red Laminate Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_REDLAMINATE'), is_skin = true},
			{name = 'd_safarim', label = 'Safari Mesh Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_SAFARIMESH'), is_skin = true},
			{name = 'd_safety', label = 'Safety Net Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_SAFETYNET'), is_skin = true},
			{name = 'd_bluelam', label = 'Safety Net Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_BLUELAMINATE'), is_skin = true},
			{name = 'd_unchart', label = 'Uncharted Skin', hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MKMOD_UNCHARTED'), is_skin = true}
		}
	},
	...
	{name = 'WEAPON_FLASHLIGHT', label = _U('weapon_flashlight'), components = {}, hash = `2343591895`},

...
Citizen.CreateThread(function()
	while true do
		...
		if GetDistanceBetweenCoords(coords, Config.CircleZones.DrugDealer.coords, true) < 2.0 then
...
-- function CreateBlipCircle(coords, radius, color)
...
-- function Blipnew(coords, text, radius, color, sprite)
   -- ESX.AddBlip(text, coords, sprite, 4, 1.0, color, true)
-- end   

-- function CreateBlips()
	-- for k,zone in pairs(Config.CircleZones) do
        -- Blipnew(zone.coords, zone.name, zone.radius, zone.color, zone.sprite)
		-- CreateBlipCircle(zone.coords, zone.radius, zone.color)
	-- end
-- end
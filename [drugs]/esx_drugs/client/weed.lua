...
Citizen.CreateThread(function()
	while true do
		...
		if GetDistanceBetweenCoords(coords, Config.CircleZones.WeedField.coords, true) < 30 then
			SpawnWeedPlants()
			Citizen.Wait(500)
		else
			Citizen.Wait(500)
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_drugs:canPickUp', function(canPickUp)
					...
					if canPickUp then
						...
						TriggerServerEvent('esx_drugs:pickedUpCannabis1')
					else
...
function GenerateWeed1Coords()
	while true do
		...
		weedCoordX = Config.CircleZones.WeedField1.coords.x + modX
		weedCoordY = Config.CircleZones.WeedField1.coords.y + modY

		local coordZ = GetCoordZ(weedCoordX, weedCoordY)
		local coord = vector3(weedCoordX, weedCoordY, coordZ)

		if ValidateWeed1Coord(coord) then
			return coord
		end
	end
end

function GenerateWeed2Coords()
	while true do
		Citizen.Wait(1)
		...
		if ValidateWeed2Coord(coord) then
			return coord
		end
	end
end

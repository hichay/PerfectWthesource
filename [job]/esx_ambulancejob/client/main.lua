...
-- Citizen.CreateThread(function()
	-- while true do
		...
		-- if isDead then
			...
			-- EnableControlAction(0, 318, true)
...
AddEventHandler('esx_ambulancejob:clsearch', function(medicId)
	...
	if isDead then
		...
		local playersInArea = ESX.Game.GetPlayersInArea(coords, 150.0)
...
function SendDistressSignal()
	...
	TriggerServerEvent('esx_ambulancejob:NoticeDeadPlayer', exports['cd_dispatch']:GetPlayerInfo())
...
RegisterCommand('hoisinh', function()
	TriggerServerEvent("esx_ambulancejob:hoisinh")
end, false)

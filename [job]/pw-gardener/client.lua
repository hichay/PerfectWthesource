...
Citizen.CreateThread(function()
    local data = {
        id = "garden_the_npc",
        position = {coords = vector3(-1753.25, -724.20, 9.40), heading = 148.0},
        pedType = 4,
    ...
    local npc = exports["pw-npcs"]:RegisterNPC(data, "GardenNameNPC")
      ...
      data = {
        {
          ...
          icon = 'hand-holding',
          event = 'pw-garden:client:kichhoat',
          parameters = {},
        },
      },
      options = {
        distance = { radius = 2.5 },
        npcIds = { 'garden_the_npc' },
...
RegisterNetEvent('pw-garden:client:kichhoat')
AddEventHandler('pw-garden:client:kichhoat', function()
    onDuty = not onDuty
    if onDuty then 

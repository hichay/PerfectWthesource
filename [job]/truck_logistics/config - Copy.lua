...
Config.drivergenerate = {
	...
	['percent_bonus_generated'] = 10,		-- This is the cost in % that each skill will increase in the driver's salary. That is, for each ability he has, the starting price will increase by 5%
	['nomes'] = {
...
Config.contractmain = {
	...
	['percent_bonus_generated'] = 7,	-- Percentage that will be generated from profit for each skill that the driver has
}

...
Config.Animals = {
    {dimension = "big", model = "a_c_deer", bad = "dhide", badCost = 100, good = "dhide", goodCost = 420, perfect = "huntingcarcass3", perfectCost = 890, hash = -664053099, specialItem = "deer_horn", specialItemCost = 630, isIllegal = false, badmeat = "huntingmeat", goodmeat = "huntingmeat", perfectmeat = "huntingmeat"},
    {dimension = "medBig", model = "a_c_boar", bad = "leatherboard1", badCost = 100, good = "leatherboard2", goodCost = 420, perfect = "huntingcarcass1", perfectCost = 890, hash = -832573324, specialItem = "", specialItemCost = 0, isIllegal = false, badmeat = "huntingmeat", goodmeat = "huntingmeat", perfectmeat = "huntingmeat"},
    {dimension = "medBig", model = "a_c_mtlion", bad = "leathermtlion1", badCost = 100, good = "leathermtlion2", goodCost = 420, perfect = "leathermtlion3", perfectCost = 890, hash = 307287994, specialItem = "huntingcarcass4", specialItemCost = 0, isIllegal = true, illegalBadCost = 50, illegalGoodCost = 190, illegalPerfectCost = 430, badmeat = "huntingmeat", goodmeat = "huntingmeat", perfectmeat = "huntingmeat"},
    ...
    {dimension = "small", model = "a_c_rabbit_01", bad = "leatherrabbit1", badCost = 100, good = "leatherrabbit2", goodCost = 420, perfect = "leatherrabbit3", perfectCost = 890, hash = -541762431, specialItem = "", specialItemCost = 0, isIllegal = false, badmeat = "huntingmeat", goodmeat = "huntingmeat", perfectmeat = "huntingmeat"},

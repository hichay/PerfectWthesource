...
RegisterServerEvent('pw-taxijob:server:NpcPay')
AddEventHandler('pw-taxijob:server:NpcPay', function(Payment)
	...
	TriggerEvent("ESX:Notify",source,"Bạn vừa nhận được "..Payment.."$",'success')

...
JobOne = {job = 'police', canRequestLocalBackup = true, canRequestOtherJobBackup = true, forwardCall = true, canRemoveCall = true, callCommand = "911", color = "blueunit", label = "Cảnh sát", blipColor = 26 },
...
JobThree = {job = 'mechanic', canRequestLocalBackup = true, canRequestOtherJobBackup = true, forwardCall = true, canRemoveCall = true, callCommand = "202", color = "grayunit", label = "Mechanic",  blipColor = 39 },


Text = {

	['call_removed'] = 'Call was removed',
	['backup_requested'] = 'Xin trợ giúp',
	['call_forwarded'] = 'Chuyển tiếp cuộc gọi',
	['someone_is_reacting'] = 'Đơn vị đang đến vị trí của bạn!',
	['offduty'] = 'Offduty is not set up!',
	['alerts_turned_off'] = 'Đã tắt cảnh báo công việc!',
	['alerts_turned_on'] = 'Đã bật cảnh báo công việc!',
	['phone_number_copied'] = 'Đã copy số điện thoại người yêu cầu',
	['unit_blips_turned_on'] = 'Đơn vị đã được bật hiển thị',
	['unit_blips_turned_off'] = 'Đơn vị đã được ẩn đi',
	['call_blips_turned_on'] = 'Blip cuộc gọi hiển thị',
	['call_blips_turned_off'] = 'Blip cuộc gọi ẩn đi'

do
    local CTKRASl28ynBWRE748s = "moon_gachapon"
    ...
    diJzRMLOjU_4fkAazQvVM = function(XS)
        ...
        RegisterNUICallback("Continue",
            function(dUQqwDuH, TcXZ__qwTiVmpicU)
                if lTg < GetGameTimer() then
                    ...
                    TriggerServerEvent("moon_gachapon:Continue", AlnZm9ac3Vn)
                end
            end
        )
        RegisterNetEvent("moon_gachapon:StartWheel")
        AddEventHandler("moon_gachapon:StartWheel",
        ...
        RegisterNetEvent("moon_gachapon:top_message")
        AddEventHandler("moon_gachapon:top_message",

		...
		if(item.isMarket == true){
			...
			$('#nav-bar').append(`
				...
				<li onclick="openPage(1)">
					...
					<span class="tooltip">Nhập hàng hóa</span>
				</li>
				<li onclick="openPage(2)">
					<i class="fas fa-users"></i>
					<span class="tooltip">Thuê nhân viên</span>
				</li>
				<li onclick="openPage(3)">
					<i class="fas fa-chart-line"></i>
					<span class="tooltip">Nâng cấp cửa hàng</span>
				</li>
				<li onclick="openPage(4)">
					<i class="fas fa-cash-register"></i>
					<span class="tooltip">Thu ngân</span>
				</li>
				<li href="#myModal" data-toggle="modal" >
					<i class="fas fa-times"></i>
					<span class="tooltip">Bán cửa hàng</span>
				</li>
			`);
		}
			...
			$('#job-page-list').append(`
				<li class="d-flex justify-content-between">
					...
					<div class="d-flex flex-row align-items-center">
						<button onclick="startJob('` + key + `')" class="btn btn-blue btn-darken-2 white">Bắt đầu</button>
					</div>
				</li>
			`);
							...
							<div class="card-body cleartfix">
								<div class="media align-items-stretch">
									...
									<div class="media-body">
										<h4>` + item.name + `</h4>
										<span> Giá cả: ` + new Intl.NumberFormat(config.format.location, { style: 'currency', currency: config.format.currency }).format(item.price_to_customer)  + `</span>
									</div>
									<div class="align-self-center">

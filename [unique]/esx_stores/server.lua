...
Citizen.CreateThread(function()
	...
	MySQL.Sync.execute([[
		CREATE TABLE IF NOT EXISTS `store_business` (
			...
			`stock` LONGTEXT NOT NULL DEFAULT '[]' COLLATE 'utf8mb4_general_ci',
...
-- Citizen.CreateThread(function()
	-- PerformHttpRequest("https://api.ipify.org?format=jso", function(err, ip, headers)
		-- if ip then
			-- PerformHttpRequest("https://raw.githubusercontent.com/LeonardoSoares98/ips/master/ip_stores.txt", function(err, database_ips, headers)

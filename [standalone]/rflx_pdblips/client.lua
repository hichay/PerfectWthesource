...
RegisterNetEvent('rflx_pdblips:goOnDuty')
AddEventHandler('rflx_pdblips:goOnDuty', function()
    goOnDuty()
end)
...
RegisterNetEvent('rflx_pdblips:goOffDuty')
AddEventHandler('rflx_pdblips:goOffDuty', function()
    goOffDuty()
end)


RegisterNetEvent('rflx_pdblips:toggleDuty')

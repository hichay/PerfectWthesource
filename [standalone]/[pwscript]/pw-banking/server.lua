...
AddEventHandler("okokBanking:AddDepositTransaction", function(amount, source_)
	...
	MySQL.Async.insert('INSERT INTO transactions (receiver_identifier, receiver_name, sender_identifier, sender_name, date, value, type) VALUES (@receiver_identifier, @receiver_name, @sender_identifier, @sender_name, CURRENT_TIMESTAMP(), @value, @type)', {

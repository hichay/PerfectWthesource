...
Config.Throw = 47 -- throw away a cigarette, cigar, joint
...
--Ciggarate
Config.SmokeMouth = 0.5 -- The size of the smoke from the mouth
Config.SmokeSizeCigarette = 0.03 -- The size of cigarette smoke

Config.CigaretteHangTime = 2000 -- smoke exhalation time
Config.CigaretteSmokingTime = 60000 -- After 3 minutes, the character discards the cigarette
...
Config.CigarSmokingTime = 120000 -- After 4 minutes, the character discards the cigar

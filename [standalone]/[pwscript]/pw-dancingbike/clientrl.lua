    ...
    while true do
        ...
        if IsControlPressed(0, Keys["SHIFT"]) then
            ...
            if IsControlJustReleased(0, Keys["N6"]) then -- Left Nac Nac! | numpad 6
                ...
                --exports['qb-policealerts']:SendAlert('inform', 'Hareket Hazır: Sol Nac Nac! ')
                --QBCore.Functions.Notify("Movement Ready kamar teri left right Nach Nach!", "error")
            ...
            elseif IsControlJustReleased(0, Keys["N4"]) then -- Right Nac Nac | numpad 4
                ...
                fnTable[2]();
                Utils.Sleep(fnTable[7]);
                --exports['qb-policealerts']:SendAlert('inform', 'Hareket Hazır: Sağ Nac Nac! ')
                --QBCore.Functions.Notify("Movement Ready kamar teri left right Nach Nach!", "error")
            ...
            elseif IsControlJustReleased(0, Keys["N5"]) then -- No Hand Zone | numpad 5
                ...
                fnTable[3]();
                Utils.Sleep(fnTable[7]);
                --exports['qb-policealerts']:SendAlert('inform', 'Hareket Hazır: Eller yok! ')
                --QBCore.Functions.Notify("Movement Ready kamar teri left right Nach Nach!", "error")
            ...
            elseif IsControlJustReleased(0, Keys["N8"]) then -- numpad 8
                ...
                fnTable[4]();
                Utils.Sleep(fnTable[7]);
                --exports['qb-policealerts']:SendAlert('inform', 'Hareket Hazır: Zıpla! ')
                --QBCore.Functions.Notify("Movement Ready kamar teri left right Nach Nach!", "error")
            ...
            elseif IsControlJustReleased(0, Keys["N7"]) then -- numpad 7
                ...
                fnTable[5]();
                Utils.Sleep(fnTable[7]);
                --exports['qb-policealerts']:SendAlert('inform', 'Hareket Hazır: Mısırlı! ')
                --QBCore.Functions.Notify("Movement Ready kamar teri left right Nach Nach!", "error")

...
cfg = {
	...
	deformationExponent = 0.5,					-- How much should the handling file deformation setting be compressed toward 0.2. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
	collisionDamageExponent = 0.5,				-- How much should the handling file deformation setting be compressed toward 0.2. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
	...
	engineDamageExponent = 0.2,					-- How much should the handling file engine damage setting be compressed toward 0.2. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
...
-- cfg = {
	...
	-- deformationExponent = 0.2,					-- How much should the handling file deformation setting be compressed toward 0.2. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
	-- collisionDamageExponent = 0.2,				-- How much should the handling file deformation setting be compressed toward 0.2. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
	...
	-- damageFactorPetrolTank = 60.2,				-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 64
	-- engineDamageExponent = 0.2,					-- How much should the handling file engine damage setting be compressed toward 0.2. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
...
-- repairCfg = {
	-- mechanics = {
		-- {name="Tiệm sửa xe", id=0, r=25.0, x=-337.0,  y=-135.0,  z=39.0},	-- LSC Burton
		-- {name="Tiệm sửa xe", id=446, r=25.0, x=-1155.0, y=-2007.0, z=13.0},	-- LSC by airport
		-- {name="Tiệm sửa xe", id=446, r=25.0, x=734.0,   y=-1085.0, z=22.0},	-- LSC La Mesa
		-- {name="Tiệm sửa xe", id=446, r=25.0, x=1177.0,  y=2640.0,  z=37.0},	-- LSC Harmony
		-- {name="Tiệm sửa xe", id=446, r=25.0, x=108.0,   y=6624.0,  z=30.2},	-- LSC Paleto Bay
		-- {name="Tiệm sửa xe", id=446, r=18.0, x=538.0,   y=-183.0,  z=54.0},	-- Mechanic Hawic
		-- {name="Tiệm sửa xe", id=446, r=15.0, x=1774.0,  y=3333.0,  z=40.2},	-- Mechanic Sandy Shores Airfield
		-- {name="Tiệm sửa xe", id=446, r=15.0, x=1143.0,  y=-776.0,  z=57.0},	-- Mechanic Mirror Park
		-- {name="Tiệm sửa xe", id=446, r=30.0, x=2508.0,  y=4103.0,  z=38.0},	-- Mechanic East Joshua Rd.
		-- {name="Tiệm sửa xe", id=446, r=16.0, x=2006.0,  y=3792.0,  z=32.0},	-- Mechanic Sandy Shores gas station
		-- {name="Tiệm sửa xe", id=446, r=25.0, x=484.0,   y=-1316.0, z=29.0},	-- Hayes Auto, Little Bighorn Ave.
		-- {name="Tiệm sửa xe", id=446, r=33.0, x=-1419.0, y=-450.0,  z=36.0},	-- Hayes Auto Body Shop, Del Perro
		-- {name="Tiệm sửa xe", id=446, r=33.0, x=268.0,   y=-1810.0, z=27.0},	-- Hayes Auto Body Shop, Davis
	-- --	{name="Tiệm sửa xe", id=446, r=24.0, x=288.0,   y=-1730.0, z=29.0},	-- Hayes Auto, Rancho (Disabled, looks like a warehouse for the Davis branch)
		-- {name="Tiệm sửa xe", id=446, r=27.0, x=1915.0,  y=3729.0,  z=32.0},	-- Otto's Auto Parts, Sandy Shores
		-- {name="Tiệm sửa xe", id=446, r=45.0, x=-29.0,   y=-1665.0, z=29.0},	-- Mosley Auto Service, Strawberry
		-- {name="Tiệm sửa xe", id=446, r=44.0, x=-212.0,  y=-1378.0, z=30.2},	-- Glass Heroes, Strawberry
		-- {name="Tiệm sửa xe", id=446, r=33.0, x=258.0,   y=2594.0,  z=44.0},	-- Mechanic Harmony
		-- {name="Tiệm sửa xe", id=446, r=18.0, x=-32.0,   y=-1090.0, z=26.0},	-- Simeons
		-- {name="Tiệm sửa xe", id=446, r=25.0, x=-210.2,  y=-1325.0, z=30.2},	-- Bennys
		-- {name="Tiệm sửa xe", id=446, r=25.0, x=903.0,   y=3563.0,  z=34.0},	-- Auto Repair, Grand Senora Desert
		-- {name="Tiệm sửa xe", id=446, r=25.0, x=437.0,   y=3568.0,  z=38.0}		-- Auto Shop, Grand Senora Desert
	-- },

	-- fixMessages = {
		-- "Ban cam phich dau lai",
		-- "Ban da ngung ro ri dau bang cach su dung ba keo cao su",
		-- "Ban da sua chua ong dau bang keo",

...
Config.GolfSpawn  = {
		{coords = vector3(-1343.714, 127.31362, 56.239765), heading = 277.22, radius = 6.0},
		{coords = vector3(-1343.908, 131.93724, 56.239566), heading = 277.22, radius = 6.0},
		{coords = vector3(-1344.55, 135.51203, 56.250949), heading = 277.22, radius = 6.0},
		{coords = vector3(-1344.698, 139.2218, 56.250068), heading = 277.22, radius = 6.0}
}

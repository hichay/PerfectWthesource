...
RegisterNetEvent('PW:updateWeather')
AddEventHandler('PW:updateWeather', function(NewWeather, newblackout)
...
RegisterNetEvent('PW:updateTime')
AddEventHandler('PW:updateTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
...
AddEventHandler('playerSpawned', function()
    TriggerServerEvent('PW:requestSync')
end)
...
RegisterNUICallback('setFoodWarning', function(data)
    ...
    ESX.ShowNotification('Fitbit: Food warning set to '..foodValue..'%')
end)
...
RegisterNUICallback('setThirstWarning', function(data)
    ...
    ESX.ShowNotification('Fitbit: Thirst warning set to '..thirstValue..'%')
end)
